        ...
        <section>
            <div className='gap-8 grid grid-cols-3 px-8 text-base-100'>
                <div className='bg-gradient-to-r flex from-primary px-3 py-6 rounded-xl space-x-3 to-secondary'>
                    <div className='flex items-center justify-center w-1/4'><img className='w-3/4' src={clock} alt="" /></div>
                ...
                <div className='bg-accent flex px-3 py-6 rounded-xl space-x-3'>
                    <div className='flex items-center justify-center w-1/5'><img className='w-3/5' src={marker} alt="" /></div>
                ...
                <div className='bg-gradient-to-r flex from-primary px-3 py-6 rounded-xl space-x-3 to-secondary'>
                    <div className='flex items-center justify-center w-1/4'><img className='w-3/4' src={phone} alt="" /></div>
