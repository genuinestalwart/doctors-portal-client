			...
			<div className='hero pl-12 pr-28'>
				<div className='gap-0 hero-content p-0'>
					...
					<div className='text-base-100 w-1/2'>
						...
						<button className='bg-gradient-to-r border-0 btn btn-primary font-semibold from-primary hover:from-primary-focus mt-6 shadow-lg shadow-secondary/50 hover:shadow-primary/50 to-secondary hover:to-secondary-focus text-base-100'>
							Get Started
						</button>
					</div>
				</div>
