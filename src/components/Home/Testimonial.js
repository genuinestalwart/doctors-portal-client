...
const Testimonial = () => {
	return (
		<section className="bg-[url('/src/assets/icons/quote.svg')] bg-right-top bg-no-repeat bg-[length:15%_25%] mt-24">
			<h5 className='font-bold ml-12 text-primary text-lg'>
				Testimonial
			</h5>
			<h3 className='font-medium ml-12 mt-2 mb-20 text-2xl'>
			...
			<div className='gap-12 grid grid-cols-3 px-16'>
				<div className='gap-6 grid grid-rows-2 p-6 place-content-between rounded-xl shadow-lg'>
					...
					<div className='flex items-center'>
						<div className='w-1/4'>
							<img
								className='ring-2 ring-offset-2 ring-primary rounded-full w-full'
								src={people1}
								alt=''
							/>
						</div>
